const typed = new Typed('.typed', {
	strings: [
		'<i class="direct">Mexicano</i>',
		'<i class="direct">Hidrocalido</i>',
		'<i class="direct">Ranchero</i>',
		'<i class="direct">Hola Mundo ;)</i>'
	],
...
const typed3 = new Typed('.typed3', {
	strings: [
		'<i class="direct">Linkedln</i>',
		'<i class="direct">GitHub</i>',
		'<i class="direct">Instagram</i>',
		'<i class="direct">Twitter</i>',
		'<i class="direct">Google Developers</i>'
	],
